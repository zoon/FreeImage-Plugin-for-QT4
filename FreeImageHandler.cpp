...
// FreeImageHandler STATIC MEMBERS ////////////////////////////////////
...
QImage& FreeImageHandler::QImageNone()
{
    static QImage none(0,0,QImage::Format_Invalid);
    return none;
}

bool FreeImageHandler::IsQImageNone(const QImage& img)
{
    return img == QImageNone();
}

QVector<QRgb>& FreeImageHandler::PaletteNone()
{
    static QVector<QRgb> none = QVector<QRgb>();
    return none;
}

bool FreeImageHandler::IsPaletteNone(const QVector<QRgb>& pal)
{
...
FREE_IMAGE_FORMAT FreeImageHandler::GetFIF(QIODevice *device, 
...
QByteArray FreeImageHandler::name() const
{
    return "freeimage";
}
